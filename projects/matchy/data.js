...
noises[0] = "Roar!";
noises.push("Meow");
noises.unshift("They're Great!");
noises.push("Carol Baskin did it!");
...
var lion = { species: 'lion', name: 'Simba', noises: ['hakuna matata', 'scar', 'king', 'nazzwanaa']};
animals.push(lion);
console.log(animals);

var turtle =  {species: 'mutant', name: 'Michalangelo', noises: ['Cowabunga', 'Pizza Time']};
animals.push(turtle);
console.log(animals);
 ...
 */
 ...
 var friends = [];//friends should be an ordered list.

...
function greeter(hour) {
    ...
    if (hour <= 11) {      // if hour less than or equal to 11 print Good Morning! to the console
        console.log("Good Morning!");
        
    } else if (hour <=16) {   // if hour is less than or equal to 16 print Good Afternoon! to the console.
        console.log("Good Afternoon!");  
        
    } else if (hour <= 21) {   // if hour is less than or equal to 21 print Good Evening! to the console.
        console.log("Good Evening!");
        
    } else {    // if hour is none of the above print Good Night! to the console.
